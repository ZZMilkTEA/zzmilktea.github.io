...
Shape.prototype.getImage = function (){
    ...
    ctx.fillText(this.text[1], this.x, this.y - 130);
    ctx.fillText(this.text[2], this.x, this.y + 130);
...
function draw() {
    ...
    // ctx.fillText(shape.text,ww/2,wh/2);
    ctx.fillStyle = "yellow";
    ctx.font = "12px arial"
    ctx.fillText("当前的粒子数量:"+ count + "  粒子就位率:" + (digits/quantity*100).toFixed(2) + "%",80,20);
